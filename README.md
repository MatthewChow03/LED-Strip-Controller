...
This video shows the terminal interface, multiple commands, and the LED indicators on the breadboard—green is for transmit, blue is for receive, and red is for transmit command invalid.
